...
def fit_cnn_model(x_train, y_train, id, optimizer='rmsprop', loss='categorical_crossentropy', epochs=40, batch_size=8):
    ...
    plt.savefig('plots/cnn_plot_{}.png'.format(id))
    ...
    plot_model(model, to_file='models/model_cnn_{}.png'.format(id), show_shapes=True, show_layer_names=True)
